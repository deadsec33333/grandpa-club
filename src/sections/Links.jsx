...
const Links = () => {
  const cards = [
    { title: "PUMPFUN", text: "BUY NOW", link: "https://pump.fun/DWvGbXULoN3LwwGFvGswot6bq3UTvhuDMwrXWu1Dpump", image: img2 },
    ...
    { title: "DEXSCREENER", text: "BUY NOW", link: "https://pump.fun/DWvGbXULoN3LwwGFvGswot6bq3UTvhuDMwrXWu1Dpump", image: cardImage2 }
  ];
