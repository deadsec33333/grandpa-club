...
const Links = () => {
  const cards = [
    { title: "PUMPFUN", text: "BUY NOW", link: "https://pump.fun/EcAcVUQznhJiwPoNDGeHNfm3ARRVJNXv8NFs8oaApump", image: img2 },
    ...
    { title: "DEXSCREENER", text: "BUY NOW", link: "https://pump.fun/EcAcVUQznhJiwPoNDGeHNfm3ARRVJNXv8NFs8oaApump", image: cardImage2 }
  ];
